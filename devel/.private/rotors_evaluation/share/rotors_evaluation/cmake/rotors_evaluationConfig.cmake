...
if("TRUE" STREQUAL "TRUE")
  set(rotors_evaluation_SOURCE_PREFIX /home/drone/Documents/ewok_ws_d455/src/Ewok-Planner/ewok/rotors_simulator/rotors_evaluation)
  set(rotors_evaluation_DEVEL_PREFIX /home/drone/Documents/ewok_ws_d455/devel/.private/rotors_evaluation)
  ...
  set(rotors_evaluation_INSTALL_PREFIX /home/drone/Documents/ewok_ws_d455/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'rotors_evaluation' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/drone/Documents/ewok_ws_d455/src/Ewok-Planner/ewok/rotors_simulator/rotors_evaluation/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/drone/Documents/ewok_ws_d455/devel/.private/rotors_evaluation/lib;/home/drone/Documents/ewok_ws_d455/devel/lib;/home/drone/Documents/ewok_ws/devel/lib;/opt/ros/melodic/lib)
